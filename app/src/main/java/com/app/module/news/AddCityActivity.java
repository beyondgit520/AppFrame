...
import com.app.module.news.entity.PickerViewData;
import com.app.module.news.entity.ProvinceBean;
...
//        pwOptions.setLabels("省", "市", "区");
        pvOptions.setTitle(getString(R.string.pickerview_select_city));
